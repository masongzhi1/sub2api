...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	authHandler := handler.NewAuthHandler(configConfig, authService, userService, apiKeyService, settingService, promoService, redeemService, totpService)
	...
	tokenManagementService := service.NewTokenManagementService(userRepository, subscriptionService, apiKeyService, settingService, configConfig)
	...
	tokenManagementHandler := admin.NewTokenManagementHandler(tokenManagementService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, tokenManagementHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, adminAPIKeyHandler, scheduledTestHandler)
